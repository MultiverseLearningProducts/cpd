        ...
        <section>
            ...
            <main id="help" className="pa3 br3 overflow-y-scroll">
                <section className="bg-mv-white-dwarf pa3 br3">
                    ...
                    <p>This help page is your place to start. The app has 3 components to help you grow and develope your coaching practice here at Multiverse.</p>
                    ...
                    <p><span className="cb fl"><CalIcon /></span><strong>Observations in your Google calendar</strong> you can manage reflections and feedbacks here. Booked observations will appear here, and observations that have taken place and need your feedback you'll be able to see and manage here. To mark a calendar event so that it appears here use the text <span className="b code">(obs)</span> in your event title and we should pick it up in the Observatory. If you are the organiser of the google event you will be considered the coach being observed. We invite observation. If you are a guest to an event labelled <span className="b code">(obs)</span> you are the observer and will provide feedback and tag that session.</p>
                    <h2>The flow</h2>
                    ...
                    <p>Recordings of observations will bring some rigour to our coach scoring system. We want to create an audit trail linking rubric tags with corresponding video evidence of that aspect of the rubric being demonstrated in the recording. This will help other coaches searching for examples of a particular skill from the rubric find your recording. However not every session needs to have a recording.</p>
                    ...
                    <h2>Your Score</h2>
                    <p>It will take time to build out your coaching score. Over the months and years you want to be aiming to have your coach score radar chart display a wide round circle. The circle indicates that you have demonstrated competency in all aspects of the rubric, your wide circle indicates a high score, where you have been observed demonstrating the rubric many, many times.</p>
